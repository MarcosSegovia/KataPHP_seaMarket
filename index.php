...
$seaMarket = new SeaMarket();

$products = array('vieira' => 50, 'pulpo' => 100, 'centollo' => 50);

$earningsMadrid = $seaMarket->getFinalValueByLocation($products, 'Madrid');
$earningsBarcelona = $seaMarket->getFinalValueByLocation($products, 'Barcelona');
$earningsLisboa = $seaMarket->getFinalValueByLocation($products, 'Lisboa');

$selected = $seaMarket->retrieveBiggerNumber($earningsBarcelona, $earningsMadrid, $earningsLisboa);
...
switch($selected)
{
    ...
    case $earningsBarcelona:
        echo 'Go to Barcelona !';
        break;
